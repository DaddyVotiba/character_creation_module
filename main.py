...
def attack(char_name: str, char_class: str) -> str:
    """Метод для расчета урона при атаке игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Метод для расчета количества единиц блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Метод для расчета увеличения выносливости, атаки и.
    защиты при применении специальных навыков.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Метод для для выбора персонажа игроком."""
